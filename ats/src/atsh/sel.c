...
GtkWidget *create_label_sel(char *winfo, int p1,int p2,int p3,int p4, GtkWidget *table)
{
  GtkWidget *label = gtk_label_new (winfo);
  //  gtk_label_set_line_wrap(GTK_LABEL (label),TRUE);
  gtk_table_attach (GTK_TABLE (table), label, p1, p2, p3, p4, 0, GTK_EXPAND, 0, 0);
...
{
  GtkWidget *window1, *table1, *lfrom, *lto, *lstep, *ltres, *lmet;
  GtkWidget *OK, *cancel, *metb, *hseparator2, *hseparator1, *tlabel;
  GtkObject *step_adj, *to_adj, *from_adj, *tres_adj;
  ...
  if(floaded) {
    ...
    g_signal_connect (G_OBJECT (window1), "destroy",
                      G_CALLBACK (destroy_smartsel),window1);
    ...
    /* LABELS */
    lfrom=create_label_sel("From Partial #",     0,1,0,1,table1);
    lto  =create_label_sel("To   Partial #",     0,1,1,2,table1);
    lstep=create_label_sel("Jump by       ",     0,1,2,3,table1);
    ltres=create_label_sel("Amp. Treshold(dB)",  0,1,3,4,table1);
    lmet =create_label_sel("Amp. Evaluation" ,   0,1,4,5,table1);
    ...
    g_signal_connect (G_OBJECT (metb), "toggled",
                      G_CALLBACK (set_met),tlabel);
    gtk_container_add (GTK_CONTAINER (metb), tlabel);
    gtk_table_attach (GTK_TABLE (table1), metb, 1, 2, 4, 5,
                      (GtkAttachOptions) (0),
                      (GtkAttachOptions) (0), 0, 0);
    gtk_widget_set_size_request (metb, 72, 32);
    ...
    gtk_widget_ref (OK);
    g_object_set_data_full (G_OBJECT (window1), "OK", OK,
                              (GDestroyNotify) gtk_widget_unref);
    gtk_widget_show (OK);
    ...
    g_object_set_data_full (G_OBJECT (window1), "cancel", cancel,
                              (GDestroyNotify) gtk_widget_unref);
    gtk_widget_show (cancel);
    gtk_table_attach (GTK_TABLE (table1), cancel, 0, 1, 6, 7,
                      (GtkAttachOptions) (0),
                      (GtkAttachOptions) (0), 0, 0);
    gtk_widget_set_size_request (cancel, 72, 32);
  
  
    hseparator2 = gtk_hseparator_new ();
    gtk_widget_ref (hseparator2);
    g_object_set_data_full (G_OBJECT (window1), "hseparator2", hseparator2,
                              (GDestroyNotify) gtk_widget_unref);
    ...
    g_object_set_data_full (G_OBJECT (window1), "hseparator1", hseparator1,
                              (GDestroyNotify) gtk_widget_unref);
    ...
    g_signal_connect (G_OBJECT (OK), "clicked",G_CALLBACK (do_smartsel),window1);
    g_signal_connect (G_OBJECT (cancel), "clicked",G_CALLBACK (destroy_smartsel),window1);
